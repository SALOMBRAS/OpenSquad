# Carrossel infinito — fundos contínuos (rico-pneus-carousel)
...
- **Pasta:** `squads/rico-pneus-carousel/output/{run_id}/v1/backgrounds/`
...
Sempre alinhar a [`design-system-rico-pneus-colors.md`](design-system-rico-pneus-colors.md).
